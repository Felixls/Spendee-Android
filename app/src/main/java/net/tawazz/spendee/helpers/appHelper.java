...
public class AppHelper {
    ...
    public static ArrayList<Tags> getExpTags(){
        ...
        ArrayList<String> icons = new ArrayList<>(
                Arrays.asList("{fa-cutlery}","{fa-car}","{fa-credit-card}",
                        ...
                        "{fa-heart}","{fa-home}","{fa-shopping-cart}","{fa-mobile}","{fa-ticket}","{fa-hand-pointer-o}")
        );
    ...
    public static ArrayList<Tags> getIncTags(){
        ...
        try{
            tagsArray = new JSONArray(
                    "[{\"id\":\"22\",\"name\":\"Savings\"}, {\"id\":\"23\",\"name\":\"Gifts\"}, {\"id\":\"24\",\"name\":\"Other\"}, {\"id\":\"25\",\"name\":\"Salary\"}, {\"id\":\"26\",\"name\":\"Loan\"}, {\"id\":\"27\",\"name\":\"Extra Income\"}, {\"id\":\"28\",\"name\":\"Business\"}, {\"id\":\"30\",\"name\":\"Fees\"}, {\"id\":\"31\",\"name\":\"Interest\"}]");
        }catch (JSONException e){
